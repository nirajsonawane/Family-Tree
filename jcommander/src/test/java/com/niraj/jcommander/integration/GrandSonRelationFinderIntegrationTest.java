...
@SpringBootTest
public class GrandSonRelationFinderIntegrationTest {
	...
	public void shouldFindGrandFatherForPerson() {
		...
		String[] input1 = { "Person=Evan", "Relation=Grandson" };
		String process = commondProcessor.process(input1);
		Assert.assertTrue(process.contains("Jacob"));
		...
		String[] input3 = { "Person=Alex", "Relation=Grandson" };
		String process3 = commondProcessor.process(input3);
		Assert.assertTrue(process3.contains("Bern"));
		
		String[] input2 = { "Person=Adam", "Relation=Grandson" };
		String process2 = commondProcessor.process(input2);
		Assert.assertTrue(process2.contains("Stev"));
		Assert.assertTrue(process2.contains("Roger"));
